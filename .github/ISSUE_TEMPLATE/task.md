...
- **否定的**な言葉を使わなくても説明はできる。Explain the issue without a **negative** sentence.
...
You need to communicate with the team when this section is empty. Remove this message when you start writing.
